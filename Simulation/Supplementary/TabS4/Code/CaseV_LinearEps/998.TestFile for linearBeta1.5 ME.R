...

{
  ...
  source(file = "./Simulation/Supplementary/TabS4/Code/CaseV_LinearEps/999.ObjectiveGradient_NormalME.R")
  ...
  # Variable Information----
{
  ...
  # linear parameter for controling the measurement error model X*= beta \times X + \epsilon
  # beta_error <- 0.5
  beta_error <- 1.5
}
  ...
  for (var_eps in vec_Vareps) {
      ...
      # Construct replicated covariate dataset
    {
      ...
      for (k in 1:r) {
        ...
        X_Normal[[k]] <- beta_error * trueX + measure.error_Normal[[k]]
...
# Save .Rdata
save.image(file = "CompareAllMethods_linearbeta1.5_Original.RData")
  ...
  # Table output----
{
  ...
  mat_Rc_Normal <- rbind(Rc_ebme_Normal,
                         ...
                         Rc_hcc_Normal,
                         Rc_hyj_Normal)
  csvName_mat_Rc_Normal <- paste0("mat_linearbeta1.5_ConvergenceRate_N", N,
                                  "_Sim", N_Sim, ".csv")
  ...
  csvName_mat_avgSim <- paste0("mat_linearbeta1.5_avgSim_theta_ATT_N", N, "_Sim", N_Sim,
                               ".csv")
  ...
  csvName_mat_BiasSdMSE <- paste0("mat_linearbeta1.5_BiasSdMSE_theta_ATT_N", N, "_Sim", N_Sim,
                                  ".csv")
  ...
  # Plots----
{
  ...
  p_Rc_NormalEps <- ggplot(Rcdf_Normal) +
    ...
    theme_bw()
  p_Rc_NormalEps
  ggsave(filename = "p_linearbeta1.5_Rc.pdf", p_Rc_NormalEps,
         width = 14, height = 13,
         units = "cm")
  ...
  ggsave(filename = "p_linearbeta1.5_AllMethods_bias_theta.pdf", p_AllMethods_bias_theta_NormalEps,
         width = 26, height = 26,
         units = "cm")
  ### bias_ATT
  ...
  ggsave(filename = "p_linearbeta1.5_AllMethods_bias_ATT.pdf", p_AllMethods_bias_ATT_NormalEps,
         width = 26, height = 10,
         units = "cm")
  ## sd
  ...
  ggsave(filename = "p_linearbeta1.5_AllMethods_sd_theta.pdf", p_AllMethods_sd_theta_NormalEps,
         width = 26, height = 26,
         units = "cm")
  ### sd_ATT
  ...
  ggsave(filename = "p_linearbeta1.5_AllMethods_sd_ATT.pdf", p_AllMethods_sd_ATT_NormalEps,
         width = 26, height = 10,
         units = "cm")
  ## MSE
  ...
  ggsave(filename = "p_linearbeta1.5_AllMethods_MSE_theta.pdf", p_AllMethods_MSE_theta_NormalEps,
         width = 26, height = 26,
         units = "cm")
  ### MSE_ATT
  ...
  ggsave(filename = "p_linearbeta1.5_AllMethods_MSE_ATT.pdf", p_AllMethods_MSE_ATT_NormalEps,
         width = 26, height = 10,
         units = "cm")
...
# Save .Rdata
save.image(file = "CompareAllMethods_linearbeta1.5_avgEdited.RData")
...
# Figure Plot: Combine the plot of normal distributed and Normal distribution----
{
  ...
  ggsave(filename = "p_linearbeta1.5_BiasSDMSE_ATT.pdf",
         Figure_NormalEps_BiasSDMSE_ATT,
         width = 33, height = 12,
         units = "cm")
}
...
openxlsx::write.xlsx(x = list_of_ASMD_NormalME,
                     file = "list_of_ASMDlinearbeta1.5ME.xlsx",
                     row.names = FALSE)
...
openxlsx::write.xlsx(x = mat_ASMD_AllMethods,
                     file = "mat_ASMD_AllMethods_linearbeta1.5ME.xlsx",
                     row.names = TRUE)